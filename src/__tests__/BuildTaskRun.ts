...
describe("BuildTaskRun Tests", () => {
  ...
  function setTaskDuration(taskRun: AbstractPipelineTaskRun, duration: number) {
    sinon.stub(taskRun, "getDuration").returns(duration);
    sinon.stub(taskRun, "ran").returns(true);
  }
